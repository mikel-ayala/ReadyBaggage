...
private var tCliente: String = "create table cliente(idCliente INTEGER PRIMARY KEY AUTOINCREMENT, email text UNIQUE NOT NULL, pass text not null, nombre text not null, apellidos text not null, telefono text not null, f_registro text not null)"
