...
class SQLHandler(context: Context, name: String, factory: SQLiteDatabase.CursorFactory?, version: Int): SQLiteOpenHelper(context, name, factory, version) {
    ...
    override fun onCreate(db: SQLiteDatabase) {
        ...
        row.put("email", "admin@gmail.com")
        row.put("pass", "Admin_1234")
        row.put("nombre", "Administrador")
        row.put("apellidos", "Oficial")
        row.put("telefono", "123456789")
        db.insert("cliente", null, row)
